        ...
        <div>
            ...
            <div className="cardGrid">
                ...
                { resources.map( (resource, index)=>(
                    <Card key={index} language={language} viewType={{cardViewEnabled, showCardView}} showExpandedView={showExpandedView} setExpandedViewContent={setExpandedViewContent} thumbnail={resource.image} contentType={resource.format} title={resource.title} endorsements={resource.endorsements} comments={resource.comments} difficulty={resource.difficulty} timeEstimate={resource.timeEstimate} description={resource.description}/>
                )) }
